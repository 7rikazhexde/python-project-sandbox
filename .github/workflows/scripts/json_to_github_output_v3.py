...
def set_github_env(name: str, value: str) -> None:
    ...
    with open(github_env, "a") as env_file:
        ...
        env_file.flush()  # 環境変数ファイルにもフラッシュを追加
        print(f"Debug: Written to GITHUB_ENV -> {name}={value}")  # デバッグ情報の追加
...
def parse_json(
    ...
    通常モードならGITHUB_OUTPUTおよびGITHUB_ENVに書き込む。
...
if __name__ == "__main__":
    ...
    # JSONデータの解析とGITHUB_OUTPUTおよびGITHUB_ENVへの書き出し（デバッグモードなら標準出力に表示）
